...
for id in range(2, sizeOfDataSet + 1):
    ...
    if makespan <= taskDag.deadline:
        ...
        print("No of tasks allocated on fog nodes: " + str(tmpSchedule.getNoOfTasksAllocatedToFogNodes()))
        print("No of tasks allocated on cloud nodes: " + str(tmpSchedule.getNoOfTasksAllocatedToCloudNodes()))
    else:
